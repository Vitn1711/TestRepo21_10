...
Функция ПечатьДоверенность(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Пока Шапка.Следующий() Цикл
		...
		Если  Не Шапка.ФИзЛицо.Пустая() Тогда
			ОбластьМакета.Параметры.ФамилияИмяОтчествоДоверенного = ОбщегоНазначенияБККлиентСервер.ПреобразоватьФИОВДательныйПадеж(СтруктураФИО, ДанныеОФизЛице.НеСклонятьФамилию);
