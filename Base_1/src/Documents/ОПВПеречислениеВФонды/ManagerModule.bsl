...
Процедура ПодготовитьДанныеДляЗаполнения(Параметры, АдресХранилища) Экспорт
	...
	Если Не Параметры.ПоУдельномуВесу Тогда
		...
		|ИЗ
		|	РегистрНакопления." + ?(Параметры.ПоДаннымОПВ, "ОПВРасчетыСФондами", "ОППВРасчетыСФондами") + ".Остатки(
...
Процедура ПодготовитьДанныеДляРасчета(Параметры, АдресХранилища) Экспорт
	...
	Если Не Параметры.ПоУдельномуВесу Тогда
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления." + ?(Параметры.ПоДаннымОПВ, "ОПВРасчетыСФондами", "ОППВРасчетыСФондами") + ".Остатки(
		|					&парамГраницаОстатков,
...
Процедура ЗаполнитьПоРасчетПениОПВиСО(Объект, Основание) Экспорт
	...
	Объект.ВидОперации = ?(Основание.ВидОперации = Перечисления.ВидыОперацийРасчетПени.РаспределениеПениОПВ ИЛИ 
	Основание.ВидОперации = Перечисления.ВидыОперацийРасчетПени.РасчетПениОПВ,
	Перечисления.ВидыОперацийОПВПеречислениеВФонды.ПеречислениеОбязательныхПенсионныхВзносов,
	Перечисления.ВидыОперацийОПВПеречислениеВФонды.ПеречислениеОбязательныхПрофессиональныхПенсионныхВзносов);
