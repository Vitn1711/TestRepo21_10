...
Функция  ПолучитьЗначениеРеквизита(ОобъектСсылка, Реквизит) Экспорт
	Возврат ОбщегоНазначения.ПолучитьЗначениеРеквизита(ОобъектСсылка, Реквизит);
КонецФункции	
...
Процедура ПодготовитьФормуНаСервере()
	...
	ДоговорКонтрагентаВалютаВзаиморасчетов = ОбщегоНазначения.ПолучитьЗначениеРеквизита(Объект.ДоговорКонтрагента, "ВалютаВзаиморасчетов");
