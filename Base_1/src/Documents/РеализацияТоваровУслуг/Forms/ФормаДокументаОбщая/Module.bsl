...
Процедура ДобавитьНоменклатуруНаСервере(Номенклатура)
	...
	РеализацияТоваровУслугФормы.ДобавитьНоменклатуруНаСервере(ЭтаФорма,Номенклатура, УникальныйИдентификатор);	
...
Процедура ЗаполнитьСпособВыписки()
	...
	СпособВыпискиАктовВыполненныхРаботИзДоговора = ОбщегоНазначения.ПолучитьЗначениеРеквизита(Объект.ДоговорКонтрагента, "СпособВыпискиАктовВыполненныхРабот");
	...
	Иначе
		Если Не ЗначениеЗаполнено(СпособВыпискиАктовВыполненныхРаботИзДоговора) Тогда			
			Если ЗначениеЗаполнено(Объект.Контрагент) И ОбщегоНазначения.ПолучитьЗначениеРеквизита(Объект.Контрагент, "ГосударственноеУчреждение") Тогда
