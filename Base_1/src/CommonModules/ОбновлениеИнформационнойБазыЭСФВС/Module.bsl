...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "БиблиотекаЭлектронныхСчетовФактур";
	Описание.Версия = ЭСФКлиентСервер.ВерсияБиблиотеки();
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ЭСФСервер.ПриДобавленииОбработчиковОбновления(Обработчики);
	// Конец Электронные счета-фактуры
	
	// Виртуальный склад
	Если Метаданные.Константы.Найти("ДатаПереходаНаУчетПоТоварамОрганизацийНаВиртуальныхСкладах") <> Неопределено Тогда
		ВССервер.ПриДобавленииОбработчиковОбновления(Обработчики);
	КонецЕсли;
	// Конец Виртуальный склад
	
	// Примечание.ОбщегоНазначения.ПодсистемаСуществует("ВиртуальныйСклад") не срабатывает,
	// потому, что у подсистемы ВиртуальныйСклад установлен признак ВключатьВКомандныйИнтерфейс.
	// Заполнение списка подсистем - общ. модуль СтандартныеПодсистемыПовтИсп.ВставитьИменаПодчиненныхПодсистем()
