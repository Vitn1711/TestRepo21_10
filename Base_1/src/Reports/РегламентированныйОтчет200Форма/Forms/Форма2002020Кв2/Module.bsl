...
Процедура ВыгрузитьТекущееПриложение(Команда)
	...
	ИмяФайла = ВыборФайлаПриложения("Приложение 200.03 №" + ТекущаяСтраница);

	Если ЗначениеЗаполнено(ИмяФайла) Тогда
		ВыгрузитьПриложение(ИмяФайла, Истина, Ложь);
	КонецЕсли;	
...
Процедура ВыгрузитьВсеПриложения(Команда)
	...
	ИмяФайла = ВыборФайлаПриложения("Приложение 200.03 №1");
	
	Если ЗначениеЗаполнено(ИмяФайла) Тогда
		ВыгрузитьПриложение(ИмяФайла,,Истина);
	КонецЕсли;	
