...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	КорСчет.Использование = ПараметрыОтчета.ПоКорСчетам;
	...
	КорСубконто1.Использование = ПараметрыОтчета.ПоКорСубконто1;
	...
	КорСубконто2.Использование = ПараметрыОтчета.ПоКорСубконто2;
	...
	КорСубконто3.Использование = ПараметрыОтчета.ПоКорСубконто3;
