...
Функция ВозможноИзменениеПараметровУчетаПоПодразделениям(ТекущееЗначениеВестиУчетПоПодразделениям)
	...
	Если ТекущееЗначениеВестиУчетПоПодразделениям Тогда
	...
	Иначе
		...
		Если ЕстьОборотыНаСчетахДоходов И ЕстьОборотыНаСчетахЗатрат Тогда
			ТекстПредупреждения = НСтр("ru = 'В оборотах счетов доходов и затрат имеются движения.
		...
		ИначеЕсли ЕстьОборотыНаСчетахДоходов Тогда
			ТекстПредупреждения = НСтр("ru = 'В оборотах счетов доходов имеются движения.
			|Аналитика по подразделениям не может быть установлена!'");
			
			Результат.Вставить("ТекстПредупреждения", ТекстПредупреждения);
			
		ИначеЕсли ЕстьОборотыНаСчетахЗатрат Тогда
			ТекстПредупреждения = НСтр("ru = 'В оборотах счетов затрат имеются движения.
			|Аналитика по подразделениям не может быть установлена!'");
