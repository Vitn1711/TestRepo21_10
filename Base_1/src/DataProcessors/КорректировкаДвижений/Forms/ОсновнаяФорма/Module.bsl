...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ (РольДоступна("ДобавлениеИзменениеДанныхБухгалтерии") ИЛИ РольДоступна("ПолныеПрава")) Тогда
...
Функция ВернутьСписокКорректировок(Документ)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ РАЗРЕШЕННЫЕ
	                      ...
	                      |	И НЕ ОперацияБух.Ссылка.ПометкаУдаления
	                      |
	                      |ОБЪЕДИНИТЬ ВСЕ
	                      |
	                      |ВЫБРАТЬ
	                      ...
	                      |	И НЕ Сторнирование.Ссылка.ПометкаУдаления");
