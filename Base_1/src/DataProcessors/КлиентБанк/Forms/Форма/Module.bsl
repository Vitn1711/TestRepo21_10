...
Процедура НастройкаКлиентБанкаПриОткрытии()
	...
	#Если НЕ ВебКлиент Тогда
		Если НЕ ЗначениеЗаполнено(Объект.ФайлВыгрузки) Тогда 
			Объект.ФайлВыгрузки = РаботаСФайламиСлужебныйКлиент.КаталогВыгрузки() + "1c_to_kl." + РасширениеЭкспорта;
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(Объект.ФайлЗагрузки) Тогда
			Объект.ФайлЗагрузки = РаботаСФайламиСлужебныйКлиент.КаталогВыгрузки() + "kl_to_1c." + РасширениеЭкспорта;
		КонецЕсли;	
	#КонецЕсли
