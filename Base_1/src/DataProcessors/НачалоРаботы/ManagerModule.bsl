...
Процедура СоздатьОрганизацию(ПараметрыСозданияОрганизации, АдресВременногоХранилища) Экспорт
	...
	Справочники.Организации.СоздатьОрганизацию(ПараметрыСозданияОрганизации, АдресВременногоХранилища);
	...
	АдресВременногоХранилища = ПоместитьВоВременноеХранилище(РезультатСозданияОрганизации, Новый УникальныйИдентификатор());
