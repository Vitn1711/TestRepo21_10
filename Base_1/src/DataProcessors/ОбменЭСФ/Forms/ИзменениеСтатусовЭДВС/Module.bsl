...
Процедура ИзменитьСтатусЭДВС(Команда)
	...
	ПараметрыФормы = Новый Структура("СписокСтруктурныхЕдиниц, ТребуетсяВыборСертификата", КоллекцияСгруппированныхЭД, Истина, ПредопределенноеЗначение("Перечисление.МодулиЭСФ.ВС"));
	
	ЭСФКлиент.ОткрытьФормуВводаДанныхИСЭСФ(ИзменитьСтатусЭДЗавершение, ПараметрыФормы);	
