...
Функция ВыполнитьМетодВебСервисаИТСНаСервере (Знач ТекстМетода, Знач ИмяВебСервиса) Экспорт
	  Возврат ВыполнитьМетодВебСервисаИТС(ТекстМетода,ИмяВебСервиса);
КонецФункции
...
Функция ПолучитьСсылкуНаСкачиваниеБиблиотеки(ДанныеПрофиля, Идентификатор = "") Экспорт
	...
	СсылкаНаСкачивание = ПолучитьСсылкуНаСкачиваниеБиблиотекиНаСервере(ОтветXML, Идентификатор);	
	Возврат СсылкаНаСкачивание;
КонецФункции

&НаСервере
Функция ПолучитьСсылкуНаСкачиваниеБиблиотекиНаСервере(ОтветXML, Идентификатор = "")
