...
Процедура ПрочитатьНастройкиПодключенияИзXMLВСтруктуру(СтруктураНастроек, ИмяФайлаСтрокаXML, ЭтоФайл, НастройкиПодключения)
	...
	Если СтруктураНастроек.Свойство("ИспользоватьПараметрыТранспортаEMAIL")
		...
		// из-за различной версии БСП и различного реквизитного состава справочника УчетнаяЗаписьЭлектроннойПочты ограничим создание учетной записи 
		Если НЕ НастройкиПодключения.ВариантНастройкиОбмена = "ОбменЗУП31БП" Тогда
