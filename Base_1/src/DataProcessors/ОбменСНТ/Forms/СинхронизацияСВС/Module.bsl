...
Процедура Синхронизировать(Команда)
	...
	Для Каждого СтрокаТаблицы Из Таблица Цикл
		Если СтрокаТаблицы.Пометка Тогда
			...
			МассивПрофилейИСЭСФСДатойСинхронизации.Добавить(Новый Структура("ПрофильИСЭСФ, ДатаНачалаСинхронизацииВходящихСНТ, ДатаНачалаСинхронизацииИсходящихСНТ", СтрокаТаблицы.ПрофильИСЭСФ, СтрокаТаблицы.ДатаНачалаСинхронизацииСНТ, Дата(1, 1, 1)));	
		КонецЕсли;
	КонецЦикла;
...
Процедура ЗаполнитьТаблицуПрофилейДляСинхронизации()
	...
	|	ЕСТЬNULL(ПараметрыМетодовИСЭСФВходящихЭСФ.ЗначениеПараметра, &ДатаПоУмолчанию) КАК ДатаНачалаСинхронизацииСНТ
	|ИЗ
	...
	Иначе
		...
		Запрос.УстановитьПараметр("Направление", Перечисления.НаправленияСНТ.Входящий);
