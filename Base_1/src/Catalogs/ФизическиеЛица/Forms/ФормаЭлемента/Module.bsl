...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЦЫ ФОРМЫ КартСчетаФизЛиц
...
Процедура ОбновитьПредставлениеЭлемента(Форма, ИмяОбновляемогоЭлемента)
	...
	ИначеЕсли ИмяОбновляемогоЭлемента = "СведенияОбИнвалидностиФизлиц" Тогда
		...
		Иначе
			СведенияОбИнвалидностиФизлицПредставлениеЗаписи = НСтр("ru = 'Не является инвалидом'");
		КонецЕсли;
	...
	ИначеЕсли ИмяОбновляемогоЭлемента = "СведенияОФизлицахУчастникахВОВ" Тогда
		...
		Иначе
			СведенияОФизлицахУчастникахВОВПредставлениеЗаписи = НСтр("ru = 'Не является участником, инвалидом ВОВ и лицом, приравненным к ним'");
		КонецЕсли;
